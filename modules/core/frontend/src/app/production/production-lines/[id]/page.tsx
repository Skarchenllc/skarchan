...
import { ProductionLine } from '@/lib/production/types';
...
export default function ProductionLineDetailPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <Link href="/production/production-lines" className="text-blue-600 hover:text-blue-700 flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-black">
                  {line.current_work_order_id ? (
                    <Link href={`/production/work-orders/${line.current_work_order_id}`} className="text-blue-600 hover:text-blue-700">
