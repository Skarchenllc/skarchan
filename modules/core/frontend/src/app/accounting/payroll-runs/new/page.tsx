...
export default function NewPayrollRunsPage() {
  const router = useRouter();

  const handleSave = async (savedRecord: any) => {
    router.push("/accounting/payroll-runs");
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="mb-6">
          <Link href="/accounting/payroll-runs" className="inline-flex items-center text-gray-600 hover:text-black">
