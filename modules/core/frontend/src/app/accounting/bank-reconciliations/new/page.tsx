...
export default function NewBankReconciliationsPage() {
  ...
  const handleSave = async (savedRecord: any) => {
    router.push("/accounting/bank-reconciliations");
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="mb-6">
          <Link href="/accounting/bank-reconciliations" className="inline-flex items-center text-gray-600 hover:text-black">
