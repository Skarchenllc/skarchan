  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="mb-6">
          <Link href="/accounting/vendors" className="inline-flex items-center text-gray-600 hover:text-black">
        ...
        <div className="border border-gray-200 rounded-lg p-8">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-black">Create Vendor</h2>
          </div>
