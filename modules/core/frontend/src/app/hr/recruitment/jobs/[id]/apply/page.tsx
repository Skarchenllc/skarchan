      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="space-y-3">
            <Link
              href={`/hr/recruitment/jobs/${jobId}`}
            ...
            <Link
              href="/hr/recruitment"
              className="block w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-700 text-center hover:bg-gray-50 transition"
            >
              View All Openings
            </Link>
          </div>
