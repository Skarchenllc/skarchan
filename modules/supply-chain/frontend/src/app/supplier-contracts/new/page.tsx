...
export default function NewSupplierContractPage() {
  ...
  const handleSave = () => {
    router.push('/supplier-contracts');
  };
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <h1 className="text-3xl font-bold text-black">New Supplier Contract</h1>
        <p className="text-gray-600 mt-1">Register a new supplier contract</p>
      </div>
