    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Track your professional development and performance goals</p>
          </div>
      ...
      {goals.length === 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">Start by creating your first professional development goal</p>
