      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Track technical assessments, aptitude tests, and skill evaluations
          </p>
        </div>
      ...
      {assessments.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Assign tests and assessments to evaluate candidate skills and abilities
          </p>
        </div>
      ) : (
        <div className="space-y-6">
              ...
              <div className="p-4 bg-gray-50 border-b">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{tests.length} assessment{tests.length > 1 ? 's' : ''}</p>
                  </div>
