      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 py-8">
          <div className="max-w-5xl mx-auto px-4">
            <Link href="/applicants" className="text-blue-600 hover:underline">← Back to Applicants</Link>
              ...
              <div>
                ...
                {requisition && (
                  <p className="text-sm text-gray-600">
                    Applied for{' '}
                    <Link href={`/job-requisitions/${requisition.id}`} className="text-blue-600 hover:underline">
