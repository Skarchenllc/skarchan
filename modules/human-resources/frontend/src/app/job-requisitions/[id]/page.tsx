      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 py-8">
          <div className="max-w-6xl mx-auto px-4">
            <Link href="/job-requisitions" className="text-blue-600 hover:underline">← Back to Job Requisitions</Link>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-start justify-between">
              ...
              <div className="flex flex-col gap-2 ml-4">
                <Link
                  href={`/applicants/new?job_requisition_id=${id}`}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            {applicants.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                No applicants yet. <Link href={`/applicants/new?job_requisition_id=${id}`} className="text-blue-600 hover:underline">Add the first applicant →</Link>
              </div>
            ) : (
                      ...
                      {(byPhase[phase.key] || []).map(a => {
                        ...
                        return (
                          <div key={a.id} className="border border-gray-200 rounded p-2 text-sm">
                            <Link href={`/applicants/${a.id}`} className="font-medium text-gray-900 hover:underline">
                              {a.name}
                            </Link>
