      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Unable to load trial balance data.
          </p>
        </div>
      </div>
    );
    ...
    <div className="container mx-auto px-4 py-8 pt-24">
        ...
        <div className="mb-6 p-4 bg-red-50 border-2 border-red-500 rounded-lg print:hidden">
          <div className="flex items-center gap-2 text-red-800">
            ...
            <div>
              ...
              <p className="text-sm">
                Debits and Credits do not match. Difference: {formatCurrency(data.difference)}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 bg-muted/30 border rounded-lg p-6 print:hidden">
        ...
        <p className="text-sm text-muted-foreground">
          The trial balance is a report that lists all general ledger accounts and their
          balances at a specific point in time. It's used to verify that the sum of all
          debit balances equals the sum of all credit balances. If they match, the books
          are "in balance" according to the double-entry accounting system.
        </p>
