        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Shows your company's financial position at a specific point in time, including
              what you own (assets), what you owe (liabilities), and what's left over (equity).
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Also known as Profit & Loss (P&L), it shows your revenue, expenses, and profit
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Tracks how cash moves in and out of your business from operating, investing,
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              A list of all accounts and their balances, used to verify that debits equal
              credits in your accounting system.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Print-ready PDF reports for physical records
              </p>
            </div>
          </div>
